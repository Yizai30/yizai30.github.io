---
title: Unreal引擎编译系统总结
tags: [Unreal, Visual Studio]
categories: [Game]
---
# 引用
...
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image.png){: w="700" h="400" .shadow }
_UnrealBuildTool 项目_
...
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image1.png){: w="700" h="400" .shadow }
_右键项目点击生成，其实执行的是 Build.bat 文件_
...
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image-1.png){: w="700" h="400" .shadow }
_UHT 生成 .generated.h 和 .gen.cpp_

UCLASS默认是NotBlueprintable，除非继承自其它的标签。
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image-2.png){: w="700" h="400" .shadow }
_UCLASS() 默认是 NotBlueprintable_

Actor类默认是Blueprintable的。
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image-3.png){: w="700" h="400" .shadow }
_AActor 默认是 Blueprintable_

各种GENERATED_BODY的宏定义。
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image-4.png){: w="700" h="400" .shadow }
_各种GENERATED_BODY的宏定义_
...
![alt text](/images/2025-12-03-Unreal引擎编译系统总结/image-5.png){: w="700" h="400" .shadow }
_手动创建模块文件夹_
